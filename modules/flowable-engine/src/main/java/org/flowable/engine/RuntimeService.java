...
public interface RuntimeService {
     ...
     * @throws FlowableObjectNotFoundException when no process definition is deployed with the given key.
     */
     ...
     *
     * @param processDefinitionKey key of process definition, cannot be null.
     * @param businessKey          a key that identifies the process instance and can be used to retrieve the process instance later via the query API.
     * @throws FlowableObjectNotFoundException when no process definition is deployed with the given key.
     */
     ...
     *
     * @param processDefinitionId the id of the process definition, cannot be null.
     * @param outcome             the form outcome of the start form, can be null.
     * @param variables           variables to be passed, can be null
     * @param processInstanceName the name of the process instance to be started, can be null.
     * @throws FlowableObjectNotFoundException when no process definition is deployed with the given id.
     */
     ...
     * </p>
     *
     * @param messageName the 'name' of the message as specified as an attribute on the bpmn20 {@code <message name="messageName" />} element.
     * @return the {@link ProcessInstance} object representing the started process instance
     * @throws FlowableException if no subscription to a message with the given name exists
     * @since 5.9
     */
     ...
     *
     * @param messageName      the 'name' of the message as specified as an attribute on the bpmn20 {@code <message name="messageName" />} element.
     * @param processVariables the 'payload' of the message. The variables are added as processes variables to the started process instance.
     * @return the {@link ProcessInstance} object representing the started process instance
     * @throws FlowableException if no subscription to a message with the given name exists
     * @since 5.9
     */
     ...
     *
     * @param processDefinitionId id of process definition for which the start form should be retrieved.
     * @param processInstanceId   id of process instance for which the start form should be retrieved.
     */
     ...
     * @throws FlowableObjectNotFoundException when no execution exists with the given executionId.
     */
     ...
     * @throws FlowableObjectNotFoundException when no execution is found for the given executionId.
     */
     ...
     * @throws FlowableObjectNotFoundException when the process instance doesn't exist.
     */
     ...
     *
     * @param executionId id of execution, cannot be null.
     * @param dataObjects the collection of DataObject names that should be retrieved.
     * @return the DataObjects or an empty map if no DataObjects are found.
     * @throws FlowableObjectNotFoundException when no execution is found for the given executionId.
     */
     ...
     * @throws FlowableObjectNotFoundException if no such execution exists.
     * @throws FlowableException               if the execution has not subscribed to the signal.
     */
     ...
     * @throws FlowableException                if an exception occurs when dispatching the event or when the {@link FlowableEventDispatcher} is disabled.
     ...
     * @throws FlowableObjectNotFoundException when the given process instance does not exist.
     */
     ...
     *
     * @param processInstanceId id of the process instance that is used to search for child executions
     ...
     * @param parentExecutionId  can be the process instance id, in case there's one multi-instance execution for the provided activity id.
     *                           In case of multiple multi-instance executions with the same activity id this can be a specific parent execution id.
     * @param executionVariables variables to be set on as local variable on the newly created multi-instance execution
     ...
     *
     * @param executionId          id of the multi-instance execution to be deleted
     * @param executionIsCompleted defines if the deleted execution should be marked as completed on the parent multi-instance execution
     */
