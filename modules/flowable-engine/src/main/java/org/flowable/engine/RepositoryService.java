...
public interface RepositoryService {
     ...
     *
     * @throws FlowableObjectNotFoundException if no deployment with the provided id can be found.
     */
     ...
     * @throws FlowableObjectNotFoundException when the resource doesn't exist in the given deployment or when no deployment exists for the given deploymentId.
     */
     ...
     *
     * @throws FlowableObjectNotFoundException if no such processDefinition can be found
     * @throws FlowableException               if the process definition is already in state suspended.
     */
     ...
     *
     * @throws FlowableObjectNotFoundException if no such processDefinition can be found or if the process definition is already in state active.
     */
     ...
     * @throws FlowableObjectNotFoundException if no such processDefinition can be found.
     * @throws FlowableException               if the process definition is already in state active.
     */
     ...
     *
     * @throws FlowableObjectNotFoundException if no process definition with the provided id can be found.
     */
     ...
     * @throws FlowableObjectNotFoundException when the process model doesn't exist.
     */
     ...
     * @throws FlowableObjectNotFoundException when the process diagram doesn't exist.
     */
     ...
     * @throws FlowableObjectNotFoundException when the process model or diagram doesn't exist.
     */
     ...
     * @throws FlowableObjectNotFoundException when the process definition or user doesn't exist.
     */
     ...
     * @throws FlowableObjectNotFoundException when the process definition or group doesn't exist.
     */
    void addCandidateStarterGroup(String processDefinitionId, String groupId);

    /**
     * Authorizes a candidate role for a process definition.
     * addBy zhangjianlin
     *
     * @param processDefinitionId id of the process definition, cannot be null.
